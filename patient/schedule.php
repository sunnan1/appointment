 ...
 <div class="container">
     ...
     <table class="menu-container" border="0">
        ...
        <?php
                ...
                $sqlmain= "select * from schedule inner join doctor on schedule.docid=doctor.docid where schedule.fromdate>='$today'  order by schedule.fromdate asc";
                $sqlpt1="";
                $insertkey="";
                $q='';
                $searchtype="All";
                        ...
                        if(!empty($_POST["search"])){
                            ...
                            $sqlmain= "select * from schedule inner join doctor on schedule.docid=doctor.docid where schedule.fromdate>='$today' and (doctor.docname='$keyword' or doctor.docname like '$keyword%' or doctor.docname like '%$keyword' or doctor.docname like '%$keyword%' or schedule.title='$keyword' or schedule.title like '$keyword%' or schedule.title like '%$keyword' or schedule.title like '%$keyword%' )  order by schedule.fromdate asc";
                            //echo $sqlmain;
                            $insertkey=$keyword;
                            ...
                            <?php
                                ...
                                for ( $x=0; $x<($result->num_rows);$x++){
                                    ...
                                    for($q=0;$q<3;$q++){
                                        ...
                                        $title=$row["title"];
                                        $docname=$row["docname"];
                                        $scheduledate=$row["fromdate"] . ' ' . $row["todate"];
                                        $scheduletime=$row["fromtime"] . ' ' . $row["totime"];
                                        if($scheduleid==""){
                                            break;
                                        }
